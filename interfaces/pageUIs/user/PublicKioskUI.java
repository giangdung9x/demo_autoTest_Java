...
public class PublicKioskUI {
	...
	public static final String NAME_OF_EVENT = "xpath=//a[text()='Giang Test auto']";
	...
	public static final String ERROR_MESSAGE_CODE_ACCESS_CONFIG_KIOSK = "xpath=//div[@class='alert-content']//p[text()='Config code incorrect!']";
	public static final String BUTTON_BACK_TO_KIOSK_FROM_SCREEN_ACCESS = "xpath=//button[text()='Back to kiosk']";
	...
	public static final String BUTTON_BACK_TO_KIOSK_FROM_SCREEN_CONFIG = "xpath=//button[text()='Back to kiosk']";
	...
	public static final String DROPDOWN_QUANTITY_TICKET = "xpath=//select[@data-name='vip3']";
