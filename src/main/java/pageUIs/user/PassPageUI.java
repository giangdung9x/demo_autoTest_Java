...
public class PassPageUI {
	...
	public static final String ADD_PASS_BUTTON= "xpath=//a[text()='Pass']";
	...
	public static final String TEXTBOX_DESCRIPTION= "xpath=//textarea[contains(@placeholder, '%s')]";
	public static final String TEXTBOX_POPUP_FIELD= "xpath=//label[text()='%s']/parent::div/following-sibling::div/input";
	public static final String TEXTBOX_PRICE= "xpath=//input[@name='pass[price]']";
	...
	public static final String PASS_CODE= "xpath=(//span[contains(text(),'Access code:')]/following::span)[3]";
